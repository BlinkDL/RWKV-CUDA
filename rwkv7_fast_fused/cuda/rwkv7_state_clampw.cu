...
__global__ void forward_kernel(int T,int H,float *__restrict__ s0_,F_ r_,F_ w_,F_ k_,F_ v_,F_ a_,F_ b_,bf* __restrict__ y_,float* s__,float* __restrict__ sa_)
{
...
{
    forward_kernel<_N_><<<dim3(H,B),dim3(_N_)>>>(T,H,s0,r,w,k,v,a,b,y,s,sa);
}
